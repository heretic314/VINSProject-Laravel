...
Route::get('/DailyDietForm', function(){
  ...
  Route::post('/CultureBiopsyForm',function(Request $request){
    $data = $request->validate([
      ...
      'cytology_000'=> ' max:255',
      'cytology_001'=> 'max:255',
      'others'=> 'required|max:255',
      'histopathology_00'=> 'max:255',
      'histopathology_01'=> 'max:255',
      'cytology_00'=> 'max:255',
      'cytology_01'=> 'max:255',
      'cytology_02'=> 'max:255',
      'type_of_biopsy_01'=> 'max:255',
      'type_of_biopsy_02'=> 'max:255',
      'type_of_biopsy_03'=> 'max:255',
      'type_of_biopsy_04'=> 'max:255',
      'type_of_biopsy_05'=> 'max:255',
