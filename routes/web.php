...
Route::group(['middleware' => ['auth']], function() {
  ...
  Route::post('/ERObservation', function(Request $request){
    $data = $request->validate([
      'date' => 'max:255',
      'triage_category' => 'max:255',
      'addressograph' => 'max:255',
      'diagnosis' => 'max:255',
      'investigation' => 'max:255',
      'time_01' => 'max:255',
      'time_02' => 'max:255',
      'time_03' => 'max:255',
      'pulse_01' => 'max:255',
      ...
      'temp_02' => 'max:255',
      'temp_03' => 'max:255',
      'iv_infusion_01' => 'max:255',
      'qty_01' => 'max:255',
      'time_start_01' => 'max:255',
      'time_end_01' => 'max:255',
      'remarks_01' => 'max:255',
      ...
      'time_end_04' => 'max:255',
      'remarks_04' => 'max:255',
      'name_drug_01' => 'max:255',
      'dosage_01' => 'max:255',
      'routine_01' => 'max:255',
      'administration_by_01' => 'max:255',
      'medication_time_01' => 'max:255',
