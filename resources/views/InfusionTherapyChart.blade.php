      ...
      <div class="col-md-6">
        ...
        <div class="col-md-6">
          ...
          @if($errors->has('ipd_no'))
  						<span class="help-block">{{ $errors->first('ipd_no') }}</span>
  				@endif
        </div>
      </div>
    </div>
      ...
      <div class="col-md-6">
        ...
        <div class="col-md-6">
          ...
          @if($errors->has('attending_consultant'))
  						<span class="help-block">{{ $errors->first('attending_consultant') }}</span>
  				@endif
        </div>
      </div>
    </div>
