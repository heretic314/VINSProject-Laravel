...
<div class="container">
	<div class="page-header">
		...
		<div class="col-md-3">
				...
				<input type ="text" class="form-control"  name="to" >   </div></div>
	...
	<div class="row">
		...
		<div class="row"><hr>
			<div class="col-md-4">Incharge
				<input type="text" name="incharge" class="form-control"></div>

			<div class="col-md-4">Administrator
				<input type="text" name="administrator" class="form-control"></div>
			<div class="col-md-4">Reciever
				<input type="text" name="reciever" class="form-control"></div>
